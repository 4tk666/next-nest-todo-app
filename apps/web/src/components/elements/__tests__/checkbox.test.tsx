...
describe('Checkbox', () => {
  ...
  it('ラベルなしでも正しく動作する', () => {
    const handleChange = vi.fn()
    render(
      <Checkbox {...defaultProps} id="no-label-test" onChange={handleChange} />,
    )
  ...
  it('適切なARIAロールが適用されている', () => {
    render(<Checkbox {...defaultProps} id="aria-role-test" />)
  ...
  it('フォーカスを受け取ることが可能', () => {
    const handleChange = vi.fn()
    render(
      <Checkbox {...defaultProps} id="keyboard-test" onChange={handleChange} />,
    )
  ...
  it('TabキーでフォーカスできることをテストするためにtabIndexが適切に設定されている', () => {
    render(<Checkbox {...defaultProps} id="tab-index-test" />)
  ...
  it('無効状態の時はdisabled属性が設定されている', () => {
    render(
      <Checkbox {...defaultProps} id="disabled-aria-test" disabled={true} />,
    )
  ...
  it('チェック状態の変更が適切にaria-checkedの変更に反映される', () => {
    const { rerender } = render(
      <Checkbox {...defaultProps} id="aria-checked-test" checked={false} />,
    )
    ...
    // チェック状態に変更
    rerender(
      <Checkbox {...defaultProps} id="aria-checked-test" checked={true} />,
    )
  ...
  it('高コントラストモードを考慮したスタイリングが適用されている', () => {
    render(<Checkbox {...defaultProps} id="contrast-test" checked={true} />)
  ...
  it('フォーカス状態で視覚的なフォーカスインジケータが表示される', () => {
    render(<Checkbox {...defaultProps} id="focus-indicator-test" />)
